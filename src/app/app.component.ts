...
@Component({
  ...
  styles: [`
    ...
    .content { flex: 1; overflow-y: auto; overflow-x: hidden; padding-bottom: calc(68px + env(safe-area-inset-bottom, 0px) + 48px); touch-action: pan-y; overscroll-behavior: contain; }
